...
const int lickPort1Pin = 47;
const int lickPort2Pin = 23;

const int lickometerOut = 26;
  ...
  if (Serial.available() > 0) {
    ...
    switch (s) {
      ...
      case -1:
        ...
        if ((s > 40 && s < 90) || (s > 90 && s != 340 && s != 400 && s != 410 && s!= 200 && s !=100)) {
          s = -1;
        }
